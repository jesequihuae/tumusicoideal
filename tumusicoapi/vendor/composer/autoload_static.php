...
class ComposerStaticInitd806512c9d77db6fa1ef470d3788e6f2
{
    ...
    public static $classMap = array (
        'Ciudad' => __DIR__ . '/../..' . '/models/Ciudad.php',
        'Dia' => __DIR__ . '/../..' . '/models/Dia.php',
        'Estado' => __DIR__ . '/../..' . '/models/Estado.php',
        'Excepcion' => __DIR__ . '/../..' . '/models/Excepcion.php',
        'Horario' => __DIR__ . '/../..' . '/models/Horario.php',
        'Instrumento' => __DIR__ . '/../..' . '/models/Instrumento.php',
        'Musico' => __DIR__ . '/../..' . '/models/Musico.php',
        'Pais' => __DIR__ . '/../..' . '/models/Pais.php',
        'Traje' => __DIR__ . '/../..' . '/models/Traje.php',
    );
